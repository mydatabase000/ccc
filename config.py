...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '6888979646:AAEfBzoLayXFuxWtmGy8L_6oiGNutqSN0qg' # Get it from https://t.me/BotFather
    APP_ID = '12089151' # Get it from my.telegram.org/apps
    API_HASH = '6b080a0eee6c4efd5fe73bbe67bb5b3c' # Get it from my.telegram.org/apps
    DATABASE_URL = 'mongodb+srv://namonarayanaya:namonarayanaya@cluster0.opvhter.mongodb.net/?retryWrites=true&w=majority' # SQL Database URL / Heroku Postgres URL
